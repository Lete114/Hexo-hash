...
function injectHash(params, content) {
  ...
  for (const mapping in mappings) {
    ...
    for (const i of relative) {
      ...
      content = content.replace(reg, `$1?${versionKey}=` + v)
    }
  }
  return content
}
